...
<div id="node-<?php print $node->nid; ?>" class=" example node-full-screen <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
        ...
        <div class="large-1 columns links">
            <div class="secondary-node-links">
              <ul class="menu vertical">
                ...
                <li class="favorite"><?php print flag_create_link('favorite', $node->nid); ?></li>
                <li class="report"><?php print flag_create_link('report', $node->nid); ?></li>
              </ul>
            </div>
        </div>
         <div class="large-11 columns content-bottom">
         <div class="content-bottom columns">
          <div class="node-right-content">
          <?php print render($content['body'][0]['#markup']); ?>
          <ul class="accordion node-accord" data-accordion data-allow-all-closed="true">
        <li class="accordion-item" data-accordion-item>
          <a class="accordion-title"><span class="show">View explanation </span> </a>
          <div class="accordion-content" data-tab-content>
           <p class="explanation"><?php print render($content['field_explanation'][0]['#markup']); ?></p>
          </div>
        </li>
        <!-- ... -->
      </ul>
