  ...
  <nav class="top-bar">
    <div class="row">
      ...
      <?php global $base_url, $language;?>
        <h1 id="logo"><a href="<?php print $base_url . '/' . $language->language; ?>" title="<?php print t('Home'); ?>" rel="dfsgfdghome" id="logo">
      ...
      <div class="top-bar-right">
        <ul class="menu">
          ...
          <li class="login-register">
            <div><i class="fa fa-user"></i> <a href="<?php print $base_path; ?>user">Login</a> / <a href="<?php print $base_path; ?>user/register">Register</a></div>
          </li>
          <?php endif; ?>
          <?php if ($user->uid): ?>
  ...
  <main role="main" class="l-main">
   ...
   <?php if ($title && !$is_front): ?>
    ...
    <div class="main columns">
      ...
      <?php endif; ?>
       <section id="landing-topic" class="clearfix data-equalizer">
      <div class="row-fluid">
      <?php if (!empty($page['sidebar_left_full_one'])): ?>
        <div class="<?php print $sidebar_first_grid; ?> columns sidebar-left">
          <div class="sidebar-left-inner">
            <?php print render($page['sidebar_left_full_one']); ?>
          </div>
        </div>
        <?php endif; ?>
        <?php if (!empty($page['content'])): ?>
        <div class="<?php print $main_grid_custom; ?> columns main-content-wrap">
          <div class="main-content">
         <?php print render($page['content']); ?>
         </div>
        </div>
        <?php endif; ?>
         <?php if (!empty($page['sidebar_right_full'])): ?>
        <div class="<?php print $sidebar_sec_grid; ?> columns sidebar-right">
          <div class="subject-content">
           <?php print render($page['sidebar_right_full']); ?>
          </div>
        </div>
      <?php endif; ?>
      </div>
      ...
      <div class="row">
        ...
        <div class="medium-6 columns">
          ...
          <div class="footer-subs clearfix">
            ...
            <ul class="menu">
              <li><input type="search" placeholder="Your email here ..."></li>
              <li><button type="button" class="button">Subscribe</button></li>
            </ul>
          </div>
...
<!--All modals
=========================-->
<div class="full reveal" id="search-modal" data-reveal data-close-on-click="true" data-animation-in="slide-in-left" data-animation-out="fade-out">
...
<div class="user-profile-img"><?php (isset($account->picture->uri)) ? ( print l(theme_image_style(array('path' => $account->picture->uri, 'style_name' => 'thumbnail')), 'user/' . $account->uid, array('html' => TRUE))) : (print custom_user_picture($account->name, $account->field_name['und'][0]['value'], $account->uid)) ; ?>
  </div><h2>Hello, <?php print $account->field_name['und'][0]['value']; ?></h2>
    <ul class="tabs hide-for-large" data-tabs id="example-tabs">
        ...
        <li class="tabs-title"><a href="#panel2">More...</a></li>
    </ul>
    <div class="tabs-content" data-tabs-content="example-tabs">
        <div class="tabs-panel is-active" id="panel1">
          <div class="medium-9 large-7 columns user-profile-link">
            <div class="small-6 medium-4 large-4 columns">
              <a href="<?php print $base_path . 'user/' . $user->uid; ?>"><i class="fa fa-user"></i>View Profile</a>
            </div>
            <div class="small-6 medium-4 large-4 columns">
              <a href="#"><i class="fa fa-cogs"></i>Edit Setting</a>
            </div>
            <div class="small-6 medium-4 large-4 columns">
              <a href="#"><i class="fa fa-comment"></i>Feedback</a>
            </div>
            <div class="clearfix"></div>
            <div class="logout"><a class="button" href="<?php print $base_path; ?>user/logout">Logout</a></div>
          </div>
        </div>
